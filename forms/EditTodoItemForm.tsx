...
const EditTodoItemForm = (props: Props) => {
    ...
    return (
        <>
            <StyledText styleStrategy="large-bold" style={{ marginBottom: 12 }}>Editing Form</StyledText>
            <StyledText>If you click &apos;<StyledText styleStrategy="bold">Confirm</StyledText>&apos;, you edit an item with title:</StyledText>
